...
def check_vocab(vocab_file, out_dir, sos=None, eos=None, unk=None):
  ...
  if tf.gfile.Exists(vocab_file):
    ...
    raise ValueError("%s vocab_file does not exist."%vocab_file)
...
def index_to_string_table_from_file(vocabulary_file, default_value):
  return lookup_ops.index_to_string_table_from_file(
    vocabulary_file, default_value=default_value)
